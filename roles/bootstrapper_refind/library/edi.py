...
# Copyright: (c) 2019, Juan Manuel "Kang" Pérez <devel@kangco.de>
...
DOCUMENTATION = '''
---
module: efi_boot_entry
short_description: Manages Boot entries
description:
  - Manages Boot entries on EFI systems
version_added: "2.9"
options:
  name:
    description:
  ...
  state:
    description:
      - Whether to create (C(present)), remove (C(absent)) or
        list (C(info)) entry/ies from EFI vars.
